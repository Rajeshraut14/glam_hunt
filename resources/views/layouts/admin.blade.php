...
<body>
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                {{ Auth::user()->name }} <img src="../../assets/images/users/1.jpg"  alt="user" class="rounded-circle" width="20">
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                ...
                                <div class="dropdown-divider"></div>
                                <a href="{{ url('/logout') }}" class="dropdown-item" href="javascript:void(0)" ><i
    ...
    <!--Custom JavaScript -->
            <script src="{{ asset('dist/js/sidebarmenu.js') }}" defer></script>
